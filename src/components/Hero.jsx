...
import BgImage from '../assets/cyber-crime.jpg';
  ...
  return (
    <div name="home" className='w-full h-screen bg-zinc-200 flex flex-col justify-between'>
      <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            ...
            <div>
                <img  className='w-full h-80' src={BgImage} alt="/"/>
            </div>
            ...
            mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl'>
               <p>Data Services</p>
                <div className='flex justify-between flex-wrap px-4'>
                   <p className='flex px-4 py-2 text-slate-500'><IoCloudUploadSharp className='h-6 text-indigo-600' />App Security</p>
